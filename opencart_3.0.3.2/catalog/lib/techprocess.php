...
if($_POST && isset($_POST['submit'])){
    ...
    <a href='<?php filter_var("http://".$_SERVER["HTTP_HOST"].$_SERVER['SCRIPT_NAME'], FILTER_VALIDATE_URL, FILTER_FLAG_PATH_REQUIRED);?>'>GO TO HOME</a>
...
<body>
    <form method="post">
     ...
     <tr>
         ...
         <td><input type="text" name="mrctCode" value="L2803"/></td>
     </tr>
     <tr>
         <td><label>Merchant Transaction ID</label></td>
         <td><input type="text" name="mrctTxtID" value="<?php echo rand(1,1000000);?>"/></td>
     </tr>
     <tr>
     ...
     <tr>
         ...
         <td><input type="text" name="txnDate" value="<?php echo date('d-m-Y');?>"/></td>
     </tr>
     <tr>
...
<tr>
 ...
 <td><input type="text" name="key" value="1165074991MUAULY"/></td>
</tr>
<tr>
 <td><label>IV</label></td>
 <td><input type="text" name="iv" value="3592961191NRATYE"/></td>
</tr>
<tr>
 <td><label>Return URL </label></td>
 <td>
     <input type="text" name="returnURL" value='<?php filter_var("http://".$_SERVER["HTTP_HOST"].$_SERVER['SCRIPT_NAME'], FILTER_VALIDATE_URL, FILTER_FLAG_PATH_REQUIRED);?>'/>
 </td>
</tr>
<tr>
    <td colspan=2>
